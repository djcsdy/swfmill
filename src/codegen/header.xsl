...
<!-- accessor definitions -->
	...
	<xsl:template match="byte|word|byteOrWord|string|fixedpoint|fixedpoint2|bit|integer|uint32|float|double|half|u30|s24|encodedu32" mode="declareAccessors" priority="-1">
